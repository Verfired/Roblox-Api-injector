...
namespace DllName
{
    public class DllName
    {
        ...
        public static string dllname = "Dll NAme.dll";
        public static string dlllink = "https://pastebin.com/raw/ or https://github.com/wqewqqwe/";
        public static string dllpipe = "Dll Pipe";
        ...
        {
            string a = CustomDownloadString("https://pastebin.com/raw/UpdateLink");
            if(a == "0")
            {
